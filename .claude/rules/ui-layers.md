...
- 작업 전 projects/<이름>/design-rules.md를 읽는다. checkpoint로 승인된 기준이 취향보다 우선
- **pages/widgets 구현은 승인된 projects/<이름>/design-rules.md(status: approved)를 전제로 한다 — 게이트가 강제(design/BEFORE_UI). 미승인이면 화면 구현 전 디자인 국면 먼저.**
